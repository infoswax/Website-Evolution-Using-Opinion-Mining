...
<div class='container-fluid'>
  ...
  <div class='collapse navbar-collapse' id='myNavbar'>
    <ul class='nav navbar-nav'>
      ...
      <li class='active'><a href='rateit.php'>Rate It</a></li>
...
<script>
  ...
  function populateCmt(data){
    ...
    $.each(data, function(key,value) {
     $("#comment").append(" <div class='col-sm-2'>\<div class='thumbnail'>\<img class='img-responsive user-photo' src='../img/avatar_2x.png'>\</div>\</div>\<div class='col-sm-10'>\<div class='panel panel-primary'>\<div class='panel-heading '>\<strong id='user'>"+value.user_id+"</strong>\</div>\<div class='panel-body' id='cmt1'>"+value.comment+"\</div>\</div>\</div> ");
