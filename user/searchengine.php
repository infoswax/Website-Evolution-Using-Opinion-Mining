...
<div class='container-fluid'>
  ...
  <div class='collapse navbar-collapse' id='myNavbar'>
    <ul class='nav navbar-nav'>
      ...
      <li class='active'><a href='searchengine.php'>Search Engine</a></li>
      ...
      if (searchWebsite == "")
        ...
        function populateSearch(data){
          ...
          $.each(data, function (key, value) {
            //console.log(data);
          $('#result').append("<tr>\<td><a href='"+value.website_name+"' target='_blank'><i class='glyphicon glyphicon-search'></i></a></td>\<td>"+value.website_name+"</td>\<td>"+value.avg_score+"</td>\<td><img class = 'imgs img-responsive center' src='../img/"+value.remark+".png' alt ='"+value.remark+"' />\</td></tr>");
