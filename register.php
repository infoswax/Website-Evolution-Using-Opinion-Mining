...
<?php
    ...
    if(isset($_POST['register'])){
        ...
        if ((mysqli_num_rows(mysqli_query($con,"SELECT * FROM `users` WHERE uEmail = '$email'"))>0 || mysqli_num_rows(mysqli_query($con,"SELECT * FROM `users` WHERE username = '$username'"))>0)){
        ...
        $result = mysqli_query($con, $insertUserSql);
         if($result)
